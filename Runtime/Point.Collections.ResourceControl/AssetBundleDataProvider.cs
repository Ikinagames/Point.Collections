...
namespace Point.Collections.ResourceControl
{
    public sealed class AssetBundleDataProvider : DataProvider<AssetBundleStrategy>
    {
        ...
        {
            return new AssetBundleStrategy(this);
        }
        ...
        public bool IsAssetLoaded(string name) => IsAssetLoaded(new Hash(name));
        public bool IsAssetLoaded(Hash key)
        {
            if (m_LoadedAssets.ContainsKey(key)) return true;
        ...
        private void SubReferenceCount(Hash key)
        {
            if (m_ReferenceCounts[key] == 1)
            {
                ...
                DataStrategy.ZeroReferenceAtReserve(this, m_AssetBundle, m_LoadedAssets[key]);
            }
            else m_ReferenceCounts[key] -= 1;
        }
    }
