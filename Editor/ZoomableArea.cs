...
{
    // https://github.com/Unity-Technologies/UnityCsReference/blob/3f0dae724475e51dab2c924c4fa470cfd0269280/Editor/Mono/Animation/ZoomableArea.cs#L15
    ...
    internal class ZoomableArea
    {
        ...
        public void BeginViewGUI()
        {
            ...
            horizontalScrollbarID = GUIUtility.GetControlID(CoreGUI.EditorGUIExt.s_MinMaxSliderHash, FocusType.Passive);
            verticalScrollbarID = GUIUtility.GetControlID(CoreGUI.EditorGUIExt.s_MinMaxSliderHash, FocusType.Passive);
        ...
        void SliderGUI()
        {
            ...
            using (new EditorGUI.DisabledScope(!enableMouseInput))
            {
                ...
                if (m_HSlider)
                {
                    ...
                    {
                        CoreGUI.EditorGUIExt.MinMaxScroller(hRangeSliderRect, horizontalScrollbarID,
                    ...
                    {
                        shownXMin = CoreGUI.GUIext.Scroller(hRangeSliderRect,
                ...
                if (m_VSlider)
                {
                    ...
                    if (m_UpDirection == YDirection.Positive)
                    {
                        ...
                        {
                            CoreGUI.EditorGUIExt.MinMaxScroller(vRangeSliderRect, verticalScrollbarID,
                        ...
                        {
                            shownYMin = CoreGUI.GUIext.Scroller(vRangeSliderRect,
