...
//{
//    // https://github.com/Unity-Technologies/UnityCsReference/blob/3f0dae724475e51dab2c924c4fa470cfd0269280/Editor/Mono/Animation/TimeArea.cs#L12
...
//            CoreGUI.HandleUtilityExt.ApplyWireMaterial();
...
//        //private static MethodInfo s_TimeFieldMethodInfo;
//        public float TimeField(Rect rect, int id, float time, float frameRate, TimeFormat timeFormat)
//        {
//            //if (s_TimeFieldMethodInfo == null)
//            //{
//            //    s_TimeFieldMethodInfo =
//            //        System.Type.GetType("TimeArea, UnityEditor.dll")
//            //        .GetMethod(
//            //            "TimeField", 
//            //            BindingFlags.Instance | BindingFlags.Public,
//            //            null,
//            //            new System.Type[] { typeof(Rect), typeof(int), typeof(float), typeof(float), 
//            //                System.Type.GetType("TimeArea.TimeFormat, UnityEditor.dll") },
//            //            null);
//            //}

//            //return s_TimeFieldMethodInfo.Invoke(this, )
//            dynamic t = 0;
//            if (timeFormat == TimeFormat.None)
//            {
//                float newTime = EditorGUI.DoFloatField(
//                     CoreGUI.EditorGUIExt.s_RecycledEditor,
//                    rect,
//                    new Rect(0, 0, 0, 0),
//                    id,
//                    time,
//                    CoreGUI.EditorGUIExt.kFloatFieldFormatString,
...
//                int hDecimals;
//                if (frameRate != 0)
//                    hDecimals = CoreGUI.MathUtilsExt.GetNumberOfDecimalsForMinimumDifference(1 / frameRate);
//                else
//                    hDecimals = CoreGUI.MathUtilsExt.GetNumberOfDecimalsForMinimumDifference(shownArea.width / drawRect.width);
...
//        {
//            int vDecimals = CoreGUI.MathUtilsExt.GetNumberOfDecimalsForMinimumDifference(shownArea.height / drawRect.height);
