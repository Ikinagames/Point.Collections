...
{
    // https://github.com/Unity-Technologies/UnityCsReference/blob/3f0dae724475e51dab2c924c4fa470cfd0269280/Editor/Mono/Animation/TickHandler.cs#L14
    ...
    internal class TickHandler
    {
        ...
        public List<float> GetTickModulosForFrameRate(float frameRate)
        {
            ...
            {
                if (System.Math.Abs(divisor - frameRate) < 1e-5)
                    break;
